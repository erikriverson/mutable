...
#
#   Last saved
#    Time-stamp:      <2010-10-24 22:55:19 erik>
#
...
parseFormula <- function(formula, data, subset, na.action) {
...
mutable.formula <- function(formula, data,
  ...
  ##   dfv <- parseFormula(formula, data, subset, na.action = na.pass)
  ## else
  ##   dfv <- parseFormula(formula, data, na.action = na.pass)
