...
#
#   Last saved
#    Time-stamp:      <2012-06-19 16:43:56 eiverson>
#
...
`+.mutable` <- function(x, y) {
  ...
  mapvars.x <- setdiff(names(x), c("formula", "data", "markup.list", "summaries"))
  mapvars.y <- setdiff(names(y), c("formula", "data", "markup.list", "summaries"))
